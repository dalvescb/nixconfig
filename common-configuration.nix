# [[file:NixOSConfiguration.org::*Template][Template:1]]
...

    {
      ...
      systemd.services."duckdns-update" = {
        script = ''
        /run/current-system/sw/bin/curl https://www.duckdns.org/update?domains=curtohome&token=d399963b-9390-4938-9a0f-9d1e5fd2d7df&ip=
        /run/current-system/sw/bin/curl https://www.duckdns.org/update?domains=curtojellyfin&token=d399963b-9390-4938-9a0f-9d1e5fd2d7df&ip=
        '';
        serviceConfig = {
          Type = "oneshot";
          User = "root";
