...
** Shell Configuration
I use zsh with a couple of non-standard plugins including the amazing
[[https://github.com/romkatv/powerlevel10k][PowerLevel10k]] which has to be fetched manually from GitHub.
...
#  LocalWords:  TouchPad nixos FlySpell
