...
* Plex Media Server
[[https://nixos.wiki/wiki/Plex][Plex]] allows you to aggregate all your personal media and access it anywhere. See
[[https://nixos.wiki/wiki/Plexreddit.com/r/Piracy/comments/12wh7ym/a_hopefully_beginner_friendly_guide_to_using_plex/][this 2023 reddit thread]] for an explanation of how to set it up with other services to "acquire media"
** Nix Plex Services
#+BEGIN_SRC nix :tangle no :noweb-ref insert-config-here
services.plex = {
  enable = true;
