...
* Graphics
** Nvidia Drivers
The propriety Nvidia driver is installed with
#+BEGIN_SRC nix :tangle no :noweb-ref insert-config-here
...
** KDE Plasma5
#+BEGIN_SRC emacs-lisp :tangle no :noweb-ref insert-config-here
services.xserver.enable = true;
services.xserver.displayManager.sddm.enable = true;
services.xserver.desktopManager.plasma5.enable = true;
#+END_SRC
...
#  LocalWords:  systemd's Nvidia VA API KDE mutably
