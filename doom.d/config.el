...
(map! :leader
      :desc "helm-buffers-list" "bb" #'helm-buffers-list)

(map! :leader
      :desc "iedit-mode" "se" #'iedit-mode)
...
;; allows company compeletion to work with underscores
;; (crucual considering I prefix all my custom yas snippets keys with s_
